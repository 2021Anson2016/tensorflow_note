...
# add hidden layer l1
l1 = add_layer(xs, 1, 10, activation_fuction=tf.nn.relu6)

# add hidden layer l2
l2 = add_layer(l1, 10, 10, activation_fuction=tf.nn.sigmoid)

# add output layer
prediction = add_layer(l2, 10, 1, activation_fuction=None)
